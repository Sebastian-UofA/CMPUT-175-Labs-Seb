...
def main():
    ...
    flower_bulbs = update_price(flower_bulbs, 'tulip', round(updated_tulip_price, 2)) # (1) sends, (dictionary, key, value) to update_price function and returns the updated dictionary
